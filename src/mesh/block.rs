    ...
    fn subdivide_2d_o2_works() -> Result<(), StrError> {
        ...
        assert_eq!(
            ...
            "SUMMARY\n\
             ...
             k:(0,1) p:[0, 1, 4] c:[0] f:[]\n\
             k:(0,3) p:[3, 0, 7] c:[0] f:[]\n\
             k:(1,8) p:[1, 8, 10] c:[1] f:[]\n\
             k:(3,14) p:[14, 3, 17] c:[2] f:[]\n\
             k:(8,9) p:[8, 9, 11] c:[1] f:[]\n\
             k:(9,18) p:[9, 18, 19] c:[3] f:[]\n\
             k:(13,14) p:[13, 14, 16] c:[2] f:[]\n\
             k:(13,18) p:[18, 13, 20] c:[3] f:[]\n\
             \n\
             BOUNDARY FACES\n\
             ==============\n"
        );
    ...
    fn subdivide_3d_works() -> Result<(), StrError> {
        ...
        assert_eq!(
            ...
            "SUMMARY\n\
             ...
             i:4 x:[0.0, 0.0, 1.0] e:[(0, 4), (4, 5), (4, 7), (4, 18)] f:[(0, 1, 4, 5), (0, 3, 4, 7), (4, 5, 18, 19), (4, 7, 18, 21)]\n\
             i:5 x:[1.0, 0.0, 1.0] e:[(1, 5), (4, 5), (5, 10), (5, 19)] f:[(0, 1, 4, 5), (1, 5, 8, 10), (4, 5, 18, 19), (5, 10, 19, 22)]\n\
             i:6 x:[1.0, 1.0, 1.0] e:[] f:[]\n\
             i:7 x:[0.0, 1.0, 1.0] e:[(3, 7), (4, 7), (7, 15), (7, 21)] f:[(0, 3, 4, 7), (3, 7, 13, 15), (4, 7, 18, 21), (7, 15, 21, 25)]\n\
             ...
             i:10 x:[2.0, 0.0, 1.0] e:[(5, 10), (8, 10), (10, 11), (10, 22)] f:[(1, 5, 8, 10), (5, 10, 19, 22), (8, 9, 10, 11), (10, 11, 22, 23)]\n\
             i:11 x:[2.0, 1.0, 1.0] e:[(9, 11), (10, 11), (11, 17), (11, 23)] f:[(8, 9, 10, 11), (9, 11, 16, 17), (10, 11, 22, 23), (11, 17, 23, 26)]\n\
             ...
             i:14 x:[1.0, 2.0, 1.0] e:[(12, 14), (14, 15), (14, 17), (14, 24)] f:[(12, 13, 14, 15), (12, 14, 16, 17), (14, 15, 24, 25), (14, 17, 24, 26)]\n\
             i:15 x:[0.0, 2.0, 1.0] e:[(7, 15), (13, 15), (14, 15), (15, 25)] f:[(3, 7, 13, 15), (7, 15, 21, 25), (12, 13, 14, 15), (14, 15, 24, 25)]\n\
             i:16 x:[2.0, 2.0, 0.0] e:[(9, 16), (12, 16), (16, 17)] f:[(2, 9, 12, 16), (9, 11, 16, 17), (12, 14, 16, 17)]\n\
             i:17 x:[2.0, 2.0, 1.0] e:[(11, 17), (14, 17), (16, 17), (17, 26)] f:[(9, 11, 16, 17), (11, 17, 23, 26), (12, 14, 16, 17), (14, 17, 24, 26)]\n\
             i:18 x:[0.0, 0.0, 2.0] e:[(4, 18), (18, 19), (18, 21)] f:[(4, 5, 18, 19), (4, 7, 18, 21), (18, 19, 20, 21)]\n\
             i:19 x:[1.0, 0.0, 2.0] e:[(5, 19), (18, 19), (19, 20), (19, 22)] f:[(4, 5, 18, 19), (5, 10, 19, 22), (18, 19, 20, 21), (19, 20, 22, 23)]\n\
             i:20 x:[1.0, 1.0, 2.0] e:[(19, 20), (20, 21), (20, 23), (20, 24)] f:[(18, 19, 20, 21), (19, 20, 22, 23), (20, 21, 24, 25), (20, 23, 24, 26)]\n\
             i:21 x:[0.0, 1.0, 2.0] e:[(7, 21), (18, 21), (20, 21), (21, 25)] f:[(4, 7, 18, 21), (7, 15, 21, 25), (18, 19, 20, 21), (20, 21, 24, 25)]\n\
             i:22 x:[2.0, 0.0, 2.0] e:[(10, 22), (19, 22), (22, 23)] f:[(5, 10, 19, 22), (10, 11, 22, 23), (19, 20, 22, 23)]\n\
             i:23 x:[2.0, 1.0, 2.0] e:[(11, 23), (20, 23), (22, 23), (23, 26)] f:[(10, 11, 22, 23), (11, 17, 23, 26), (19, 20, 22, 23), (20, 23, 24, 26)]\n\
             i:24 x:[1.0, 2.0, 2.0] e:[(14, 24), (20, 24), (24, 25), (24, 26)] f:[(14, 15, 24, 25), (14, 17, 24, 26), (20, 21, 24, 25), (20, 23, 24, 26)]\n\
             i:25 x:[0.0, 2.0, 2.0] e:[(15, 25), (21, 25), (24, 25)] f:[(7, 15, 21, 25), (14, 15, 24, 25), (20, 21, 24, 25)]\n\
             i:26 x:[2.0, 2.0, 2.0] e:[(17, 26), (23, 26), (24, 26)] f:[(11, 17, 23, 26), (14, 17, 24, 26), (20, 23, 24, 26)]\n\
             \n\
             CELLS\n\
             =====\n\
             ...
             k:(1,2) p:[2, 1] c:[] f:[(0, 1, 2, 3), (1, 2, 8, 9)]\n\
             k:(1,5) p:[1, 5] c:[] f:[(0, 1, 4, 5), (1, 5, 8, 10)]\n\
             k:(1,8) p:[8, 1] c:[] f:[(1, 2, 8, 9), (1, 5, 8, 10)]\n\
             k:(2,3) p:[3, 2] c:[] f:[(0, 1, 2, 3), (2, 3, 12, 13)]\n\
             k:(2,9) p:[2, 9] c:[] f:[(1, 2, 8, 9), (2, 9, 12, 16)]\n\
             k:(2,12) p:[12, 2] c:[] f:[(2, 3, 12, 13), (2, 9, 12, 16)]\n\
             k:(3,7) p:[7, 3] c:[] f:[(0, 3, 4, 7), (3, 7, 13, 15)]\n\
             k:(3,13) p:[3, 13] c:[] f:[(2, 3, 12, 13), (3, 7, 13, 15)]\n\
             k:(4,5) p:[5, 4] c:[] f:[(0, 1, 4, 5), (4, 5, 18, 19)]\n\
             k:(4,7) p:[4, 7] c:[] f:[(0, 3, 4, 7), (4, 7, 18, 21)]\n\
             k:(4,18) p:[18, 4] c:[] f:[(4, 5, 18, 19), (4, 7, 18, 21)]\n\
             k:(5,10) p:[10, 5] c:[] f:[(1, 5, 8, 10), (5, 10, 19, 22)]\n\
             k:(5,19) p:[5, 19] c:[] f:[(4, 5, 18, 19), (5, 10, 19, 22)]\n\
             k:(7,15) p:[7, 15] c:[] f:[(3, 7, 13, 15), (7, 15, 21, 25)]\n\
             k:(7,21) p:[21, 7] c:[] f:[(4, 7, 18, 21), (7, 15, 21, 25)]\n\
             k:(8,9) p:[9, 8] c:[] f:[(1, 2, 8, 9), (8, 9, 10, 11)]\n\
             k:(8,10) p:[8, 10] c:[] f:[(1, 5, 8, 10), (8, 9, 10, 11)]\n\
             k:(9,11) p:[9, 11] c:[] f:[(8, 9, 10, 11), (9, 11, 16, 17)]\n\
             k:(9,16) p:[16, 9] c:[] f:[(2, 9, 12, 16), (9, 11, 16, 17)]\n\
             k:(10,11) p:[11, 10] c:[] f:[(8, 9, 10, 11), (10, 11, 22, 23)]\n\
             k:(10,22) p:[10, 22] c:[] f:[(5, 10, 19, 22), (10, 11, 22, 23)]\n\
             k:(11,17) p:[17, 11] c:[] f:[(9, 11, 16, 17), (11, 17, 23, 26)]\n\
             k:(11,23) p:[11, 23] c:[] f:[(10, 11, 22, 23), (11, 17, 23, 26)]\n\
             k:(12,13) p:[13, 12] c:[] f:[(2, 3, 12, 13), (12, 13, 14, 15)]\n\
             k:(12,14) p:[14, 12] c:[] f:[(12, 13, 14, 15), (12, 14, 16, 17)]\n\
             k:(12,16) p:[12, 16] c:[] f:[(2, 9, 12, 16), (12, 14, 16, 17)]\n\
             k:(13,15) p:[15, 13] c:[] f:[(3, 7, 13, 15), (12, 13, 14, 15)]\n\
             k:(14,15) p:[15, 14] c:[] f:[(12, 13, 14, 15), (14, 15, 24, 25)]\n\
             k:(14,17) p:[14, 17] c:[] f:[(12, 14, 16, 17), (14, 17, 24, 26)]\n\
             k:(14,24) p:[24, 14] c:[] f:[(14, 15, 24, 25), (14, 17, 24, 26)]\n\
             k:(15,25) p:[25, 15] c:[] f:[(7, 15, 21, 25), (14, 15, 24, 25)]\n\
             k:(16,17) p:[16, 17] c:[] f:[(9, 11, 16, 17), (12, 14, 16, 17)]\n\
             k:(17,26) p:[17, 26] c:[] f:[(11, 17, 23, 26), (14, 17, 24, 26)]\n\
             k:(18,19) p:[19, 18] c:[] f:[(4, 5, 18, 19), (18, 19, 20, 21)]\n\
             k:(18,21) p:[18, 21] c:[] f:[(4, 7, 18, 21), (18, 19, 20, 21)]\n\
             k:(19,20) p:[19, 20] c:[] f:[(18, 19, 20, 21), (19, 20, 22, 23)]\n\
             k:(19,22) p:[22, 19] c:[] f:[(5, 10, 19, 22), (19, 20, 22, 23)]\n\
             k:(20,21) p:[20, 21] c:[] f:[(18, 19, 20, 21), (20, 21, 24, 25)]\n\
             k:(20,23) p:[23, 20] c:[] f:[(19, 20, 22, 23), (20, 23, 24, 26)]\n\
             k:(20,24) p:[20, 24] c:[] f:[(20, 21, 24, 25), (20, 23, 24, 26)]\n\
             k:(21,25) p:[21, 25] c:[] f:[(7, 15, 21, 25), (20, 21, 24, 25)]\n\
             k:(22,23) p:[23, 22] c:[] f:[(10, 11, 22, 23), (19, 20, 22, 23)]\n\
             k:(23,26) p:[26, 23] c:[] f:[(11, 17, 23, 26), (20, 23, 24, 26)]\n\
             k:(24,25) p:[25, 24] c:[] f:[(14, 15, 24, 25), (20, 21, 24, 25)]\n\
             k:(24,26) p:[24, 26] c:[] f:[(14, 17, 24, 26), (20, 23, 24, 26)]\n\
             \n\
             BOUNDARY FACES\n\
             ==============\n\
    ...
    fn subdivide_3d_o2_works() -> Result<(), StrError> {
        ...
        assert_eq!(
            ...
            "SUMMARY\n\
             ...
             i:4 x:[0.0, 0.0, 1.0] e:[(0, 4), (4, 5), (4, 7), (4, 51)] f:[(0, 1, 4, 5), (0, 3, 4, 7), (4, 5, 51, 52), (4, 7, 51, 54)]\n\
             i:5 x:[1.0, 0.0, 1.0] e:[(1, 5), (4, 5), (5, 22), (5, 52)] f:[(0, 1, 4, 5), (1, 5, 20, 22), (4, 5, 51, 52), (5, 22, 52, 63)]\n\
             i:6 x:[1.0, 1.0, 1.0] e:[] f:[]\n\
             i:7 x:[0.0, 1.0, 1.0] e:[(3, 7), (4, 7), (7, 35), (7, 54)] f:[(0, 3, 4, 7), (3, 7, 33, 35), (4, 7, 51, 54), (7, 35, 54, 71)]\n\
             ...
             i:12 x:[0.5, 0.0, 1.0] e:[(4, 5)] f:[(0, 1, 4, 5), (4, 5, 51, 52)]\n\
             i:13 x:[1.0, 0.5, 1.0] e:[] f:[]\n\
             i:14 x:[0.5, 1.0, 1.0] e:[] f:[]\n\
             i:15 x:[0.0, 0.5, 1.0] e:[(4, 7)] f:[(0, 3, 4, 7), (4, 7, 51, 54)]\n\
             i:16 x:[0.0, 0.0, 0.5] e:[(0, 4)] f:[(0, 1, 4, 5), (0, 3, 4, 7)]\n\
             i:17 x:[1.0, 0.0, 0.5] e:[(1, 5)] f:[(0, 1, 4, 5), (1, 5, 20, 22)]\n\
             i:18 x:[1.0, 1.0, 0.5] e:[] f:[]\n\
             i:19 x:[0.0, 1.0, 0.5] e:[(3, 7)] f:[(0, 3, 4, 7), (3, 7, 33, 35)]\n\
             ...
             i:22 x:[2.0, 0.0, 1.0] e:[(5, 22), (20, 22), (22, 23), (22, 63)] f:[(1, 5, 20, 22), (5, 22, 52, 63), (20, 21, 22, 23), (22, 23, 63, 64)]\n\
             i:23 x:[2.0, 1.0, 1.0] e:[(21, 23), (22, 23), (23, 45), (23, 64)] f:[(20, 21, 22, 23), (21, 23, 44, 45), (22, 23, 63, 64), (23, 45, 64, 77)]\n\
             ...
             i:27 x:[1.5, 0.0, 1.0] e:[(5, 22)] f:[(1, 5, 20, 22), (5, 22, 52, 63)]\n\
             i:28 x:[2.0, 0.5, 1.0] e:[(22, 23)] f:[(20, 21, 22, 23), (22, 23, 63, 64)]\n\
             i:29 x:[1.5, 1.0, 1.0] e:[] f:[]\n\
             i:30 x:[2.0, 0.0, 0.5] e:[(20, 22)] f:[(1, 5, 20, 22), (20, 21, 22, 23)]\n\
             i:31 x:[2.0, 1.0, 0.5] e:[(21, 23)] f:[(20, 21, 22, 23), (21, 23, 44, 45)]\n\
             ...
             i:34 x:[1.0, 2.0, 1.0] e:[(32, 34), (34, 35), (34, 45), (34, 70)] f:[(32, 33, 34, 35), (32, 34, 44, 45), (34, 35, 70, 71), (34, 45, 70, 77)]\n\
             i:35 x:[0.0, 2.0, 1.0] e:[(7, 35), (33, 35), (34, 35), (35, 71)] f:[(3, 7, 33, 35), (7, 35, 54, 71), (32, 33, 34, 35), (34, 35, 70, 71)]\n\
             ...
             i:39 x:[1.0, 1.5, 1.0] e:[] f:[]\n\
             i:40 x:[0.5, 2.0, 1.0] e:[(34, 35)] f:[(32, 33, 34, 35), (34, 35, 70, 71)]\n\
             i:41 x:[0.0, 1.5, 1.0] e:[(7, 35)] f:[(3, 7, 33, 35), (7, 35, 54, 71)]\n\
             i:42 x:[1.0, 2.0, 0.5] e:[(32, 34)] f:[(32, 33, 34, 35), (32, 34, 44, 45)]\n\
             i:43 x:[0.0, 2.0, 0.5] e:[(33, 35)] f:[(3, 7, 33, 35), (32, 33, 34, 35)]\n\
             i:44 x:[2.0, 2.0, 0.0] e:[(21, 44), (32, 44), (44, 45)] f:[(2, 21, 32, 44), (21, 23, 44, 45), (32, 34, 44, 45)]\n\
             i:45 x:[2.0, 2.0, 1.0] e:[(23, 45), (34, 45), (44, 45), (45, 77)] f:[(21, 23, 44, 45), (23, 45, 64, 77), (32, 34, 44, 45), (34, 45, 70, 77)]\n\
             i:46 x:[2.0, 1.5, 0.0] e:[(21, 44)] f:[(2, 21, 32, 44), (21, 23, 44, 45)]\n\
             i:47 x:[1.5, 2.0, 0.0] e:[(32, 44)] f:[(2, 21, 32, 44), (32, 34, 44, 45)]\n\
             i:48 x:[2.0, 1.5, 1.0] e:[(23, 45)] f:[(21, 23, 44, 45), (23, 45, 64, 77)]\n\
             i:49 x:[1.5, 2.0, 1.0] e:[(34, 45)] f:[(32, 34, 44, 45), (34, 45, 70, 77)]\n\
             i:50 x:[2.0, 2.0, 0.5] e:[(44, 45)] f:[(21, 23, 44, 45), (32, 34, 44, 45)]\n\
             i:51 x:[0.0, 0.0, 2.0] e:[(4, 51), (51, 52), (51, 54)] f:[(4, 5, 51, 52), (4, 7, 51, 54), (51, 52, 53, 54)]\n\
             i:52 x:[1.0, 0.0, 2.0] e:[(5, 52), (51, 52), (52, 53), (52, 63)] f:[(4, 5, 51, 52), (5, 22, 52, 63), (51, 52, 53, 54), (52, 53, 63, 64)]\n\
             i:53 x:[1.0, 1.0, 2.0] e:[(52, 53), (53, 54), (53, 64), (53, 70)] f:[(51, 52, 53, 54), (52, 53, 63, 64), (53, 54, 70, 71), (53, 64, 70, 77)]\n\
             i:54 x:[0.0, 1.0, 2.0] e:[(7, 54), (51, 54), (53, 54), (54, 71)] f:[(4, 7, 51, 54), (7, 35, 54, 71), (51, 52, 53, 54), (53, 54, 70, 71)]\n\
             i:55 x:[0.5, 0.0, 2.0] e:[(51, 52)] f:[(4, 5, 51, 52), (51, 52, 53, 54)]\n\
             i:56 x:[1.0, 0.5, 2.0] e:[(52, 53)] f:[(51, 52, 53, 54), (52, 53, 63, 64)]\n\
             i:57 x:[0.5, 1.0, 2.0] e:[(53, 54)] f:[(51, 52, 53, 54), (53, 54, 70, 71)]\n\
             i:58 x:[0.0, 0.5, 2.0] e:[(51, 54)] f:[(4, 7, 51, 54), (51, 52, 53, 54)]\n\
             i:59 x:[0.0, 0.0, 1.5] e:[(4, 51)] f:[(4, 5, 51, 52), (4, 7, 51, 54)]\n\
             i:60 x:[1.0, 0.0, 1.5] e:[(5, 52)] f:[(4, 5, 51, 52), (5, 22, 52, 63)]\n\
             i:61 x:[1.0, 1.0, 1.5] e:[] f:[]\n\
             i:62 x:[0.0, 1.0, 1.5] e:[(7, 54)] f:[(4, 7, 51, 54), (7, 35, 54, 71)]\n\
             i:63 x:[2.0, 0.0, 2.0] e:[(22, 63), (52, 63), (63, 64)] f:[(5, 22, 52, 63), (22, 23, 63, 64), (52, 53, 63, 64)]\n\
             i:64 x:[2.0, 1.0, 2.0] e:[(23, 64), (53, 64), (63, 64), (64, 77)] f:[(22, 23, 63, 64), (23, 45, 64, 77), (52, 53, 63, 64), (53, 64, 70, 77)]\n\
             i:65 x:[1.5, 0.0, 2.0] e:[(52, 63)] f:[(5, 22, 52, 63), (52, 53, 63, 64)]\n\
             i:66 x:[2.0, 0.5, 2.0] e:[(63, 64)] f:[(22, 23, 63, 64), (52, 53, 63, 64)]\n\
             i:67 x:[1.5, 1.0, 2.0] e:[(53, 64)] f:[(52, 53, 63, 64), (53, 64, 70, 77)]\n\
             i:68 x:[2.0, 0.0, 1.5] e:[(22, 63)] f:[(5, 22, 52, 63), (22, 23, 63, 64)]\n\
             i:69 x:[2.0, 1.0, 1.5] e:[(23, 64)] f:[(22, 23, 63, 64), (23, 45, 64, 77)]\n\
             i:70 x:[1.0, 2.0, 2.0] e:[(34, 70), (53, 70), (70, 71), (70, 77)] f:[(34, 35, 70, 71), (34, 45, 70, 77), (53, 54, 70, 71), (53, 64, 70, 77)]\n\
             i:71 x:[0.0, 2.0, 2.0] e:[(35, 71), (54, 71), (70, 71)] f:[(7, 35, 54, 71), (34, 35, 70, 71), (53, 54, 70, 71)]\n\
             i:72 x:[1.0, 1.5, 2.0] e:[(53, 70)] f:[(53, 54, 70, 71), (53, 64, 70, 77)]\n\
             i:73 x:[0.5, 2.0, 2.0] e:[(70, 71)] f:[(34, 35, 70, 71), (53, 54, 70, 71)]\n\
             i:74 x:[0.0, 1.5, 2.0] e:[(54, 71)] f:[(7, 35, 54, 71), (53, 54, 70, 71)]\n\
             i:75 x:[1.0, 2.0, 1.5] e:[(34, 70)] f:[(34, 35, 70, 71), (34, 45, 70, 77)]\n\
             i:76 x:[0.0, 2.0, 1.5] e:[(35, 71)] f:[(7, 35, 54, 71), (34, 35, 70, 71)]\n\
             i:77 x:[2.0, 2.0, 2.0] e:[(45, 77), (64, 77), (70, 77)] f:[(23, 45, 64, 77), (34, 45, 70, 77), (53, 64, 70, 77)]\n\
             i:78 x:[2.0, 1.5, 2.0] e:[(64, 77)] f:[(23, 45, 64, 77), (53, 64, 70, 77)]\n\
             i:79 x:[1.5, 2.0, 2.0] e:[(70, 77)] f:[(34, 45, 70, 77), (53, 64, 70, 77)]\n\
             i:80 x:[2.0, 2.0, 1.5] e:[(45, 77)] f:[(23, 45, 64, 77), (34, 45, 70, 77)]\n\
             \n\
             CELLS\n\
             =====\n\
             ...
             BOUNDARY EDGES\n\
             ==============\n\
             k:(0,1) p:[1, 0, 8] c:[] f:[(0, 1, 2, 3), (0, 1, 4, 5)]\n\
             k:(0,3) p:[0, 3, 11] c:[] f:[(0, 1, 2, 3), (0, 3, 4, 7)]\n\
             k:(0,4) p:[4, 0, 16] c:[] f:[(0, 1, 4, 5), (0, 3, 4, 7)]\n\
             k:(1,2) p:[2, 1, 9] c:[] f:[(0, 1, 2, 3), (1, 2, 20, 21)]\n\
             k:(1,5) p:[1, 5, 17] c:[] f:[(0, 1, 4, 5), (1, 5, 20, 22)]\n\
             k:(1,20) p:[20, 1, 24] c:[] f:[(1, 2, 20, 21), (1, 5, 20, 22)]\n\
             k:(2,3) p:[3, 2, 10] c:[] f:[(0, 1, 2, 3), (2, 3, 32, 33)]\n\
             k:(2,21) p:[2, 21, 26] c:[] f:[(1, 2, 20, 21), (2, 21, 32, 44)]\n\
             k:(2,32) p:[32, 2, 36] c:[] f:[(2, 3, 32, 33), (2, 21, 32, 44)]\n\
             k:(3,7) p:[7, 3, 19] c:[] f:[(0, 3, 4, 7), (3, 7, 33, 35)]\n\
             k:(3,33) p:[3, 33, 38] c:[] f:[(2, 3, 32, 33), (3, 7, 33, 35)]\n\
             k:(4,5) p:[5, 4, 12] c:[] f:[(0, 1, 4, 5), (4, 5, 51, 52)]\n\
             k:(4,7) p:[4, 7, 15] c:[] f:[(0, 3, 4, 7), (4, 7, 51, 54)]\n\
             k:(4,51) p:[51, 4, 59] c:[] f:[(4, 5, 51, 52), (4, 7, 51, 54)]\n\
             k:(5,22) p:[22, 5, 27] c:[] f:[(1, 5, 20, 22), (5, 22, 52, 63)]\n\
             k:(5,52) p:[5, 52, 60] c:[] f:[(4, 5, 51, 52), (5, 22, 52, 63)]\n\
             k:(7,35) p:[7, 35, 41] c:[] f:[(3, 7, 33, 35), (7, 35, 54, 71)]\n\
             k:(7,54) p:[54, 7, 62] c:[] f:[(4, 7, 51, 54), (7, 35, 54, 71)]\n\
             k:(20,21) p:[21, 20, 25] c:[] f:[(1, 2, 20, 21), (20, 21, 22, 23)]\n\
             k:(20,22) p:[20, 22, 30] c:[] f:[(1, 5, 20, 22), (20, 21, 22, 23)]\n\
             k:(21,23) p:[21, 23, 31] c:[] f:[(20, 21, 22, 23), (21, 23, 44, 45)]\n\
             k:(21,44) p:[44, 21, 46] c:[] f:[(2, 21, 32, 44), (21, 23, 44, 45)]\n\
             k:(22,23) p:[23, 22, 28] c:[] f:[(20, 21, 22, 23), (22, 23, 63, 64)]\n\
             k:(22,63) p:[22, 63, 68] c:[] f:[(5, 22, 52, 63), (22, 23, 63, 64)]\n\
             k:(23,45) p:[45, 23, 48] c:[] f:[(21, 23, 44, 45), (23, 45, 64, 77)]\n\
             k:(23,64) p:[23, 64, 69] c:[] f:[(22, 23, 63, 64), (23, 45, 64, 77)]\n\
             k:(32,33) p:[33, 32, 37] c:[] f:[(2, 3, 32, 33), (32, 33, 34, 35)]\n\
             k:(32,34) p:[34, 32, 42] c:[] f:[(32, 33, 34, 35), (32, 34, 44, 45)]\n\
             k:(32,44) p:[32, 44, 47] c:[] f:[(2, 21, 32, 44), (32, 34, 44, 45)]\n\
             k:(33,35) p:[35, 33, 43] c:[] f:[(3, 7, 33, 35), (32, 33, 34, 35)]\n\
             k:(34,35) p:[35, 34, 40] c:[] f:[(32, 33, 34, 35), (34, 35, 70, 71)]\n\
             k:(34,45) p:[34, 45, 49] c:[] f:[(32, 34, 44, 45), (34, 45, 70, 77)]\n\
             k:(34,70) p:[70, 34, 75] c:[] f:[(34, 35, 70, 71), (34, 45, 70, 77)]\n\
             k:(35,71) p:[71, 35, 76] c:[] f:[(7, 35, 54, 71), (34, 35, 70, 71)]\n\
             k:(44,45) p:[44, 45, 50] c:[] f:[(21, 23, 44, 45), (32, 34, 44, 45)]\n\
             k:(45,77) p:[45, 77, 80] c:[] f:[(23, 45, 64, 77), (34, 45, 70, 77)]\n\
             k:(51,52) p:[52, 51, 55] c:[] f:[(4, 5, 51, 52), (51, 52, 53, 54)]\n\
             k:(51,54) p:[51, 54, 58] c:[] f:[(4, 7, 51, 54), (51, 52, 53, 54)]\n\
             k:(52,53) p:[52, 53, 56] c:[] f:[(51, 52, 53, 54), (52, 53, 63, 64)]\n\
             k:(52,63) p:[63, 52, 65] c:[] f:[(5, 22, 52, 63), (52, 53, 63, 64)]\n\
             k:(53,54) p:[53, 54, 57] c:[] f:[(51, 52, 53, 54), (53, 54, 70, 71)]\n\
             k:(53,64) p:[64, 53, 67] c:[] f:[(52, 53, 63, 64), (53, 64, 70, 77)]\n\
             k:(53,70) p:[53, 70, 72] c:[] f:[(53, 54, 70, 71), (53, 64, 70, 77)]\n\
             k:(54,71) p:[54, 71, 74] c:[] f:[(7, 35, 54, 71), (53, 54, 70, 71)]\n\
             k:(63,64) p:[64, 63, 66] c:[] f:[(22, 23, 63, 64), (52, 53, 63, 64)]\n\
             k:(64,77) p:[77, 64, 78] c:[] f:[(23, 45, 64, 77), (53, 64, 70, 77)]\n\
             k:(70,71) p:[71, 70, 73] c:[] f:[(34, 35, 70, 71), (53, 54, 70, 71)]\n\
             k:(70,77) p:[70, 77, 79] c:[] f:[(34, 45, 70, 77), (53, 64, 70, 77)]\n\
             \n\
             BOUNDARY FACES\n\
             ==============\n\
