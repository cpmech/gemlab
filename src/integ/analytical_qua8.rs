...
impl AnalyticalQua8 {
    ...
    pub fn integ_nbsg(&self, s: f64) -> Matrix {
        let c = self.a*self.b*s/9.0;
        Matrix::from(&[
            [ 0.0*c, -1.0*c, -1.0*c, -1.0*c, 4.0*c, 2.0*c, 2.0*c, 4.0*c],
            [-1.0*c,  0.0*c, -1.0*c, -1.0*c, 4.0*c, 4.0*c, 2.0*c, 2.0*c],
            [-1.0*c, -1.0*c,  0.0*c, -1.0*c, 2.0*c, 4.0*c, 4.0*c, 2.0*c],
            [-1.0*c, -1.0*c, -1.0*c,  0.0*c, 2.0*c, 2.0*c, 4.0*c, 4.0*c],
        ])
    }
}
