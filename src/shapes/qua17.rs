...
/// Defines a quadrilateral with 17 points (quartic edge; interior point)
///
...
impl Qua17 {
    ...
    #[rustfmt::skip]
    pub const EDGE_POINT_IDS: [[usize; Qua17::EDGE_NPOINT]; Qua17::NEDGE] = [
        [0, 1,  8, 4, 12],
        [1, 2,  9, 5, 13],
        [2, 3, 10, 6, 14],
        [3, 0, 11, 7, 15]
    ...
    #[rustfmt::skip]
    pub const POINT_REFERENCE_COORDS: [[f64; Qua17::NDIM]; Qua17::NPOINT] = [
        [-1.0, -1.0], //  0
        [ 1.0, -1.0], //  1
        [ 1.0,  1.0], //  2
        [-1.0,  1.0], //  3
